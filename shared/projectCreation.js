...
export function buildNewProjectPayload(formState = {}) {
  ...
  return {
    ...
    currencyCode: trimStr(formState.currencyCode) || undefined,
    currencySymbol: trimStr(formState.currencySymbol) || trimStr(formState.currency) || undefined,
    currencyName: trimStr(formState.currencyName) || undefined,
    currencyCustom: !!formState.currencyCustom,
    vat: !!formState.vat,
    comment: comment || "",
