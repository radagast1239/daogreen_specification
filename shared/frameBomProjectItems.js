...
export function enrichProjectItemFromMaterial(item, materials = []) {
  ...
  return {
    ...
    category: item.category || base.category || "Прочее",
    clientSection: item.clientSection || base.clientSection || "",
    clientSubsection: item.clientSubsection || base.clientSubsection || "",
    purchaseKey: item.purchaseKey || base.purchaseKey || "",
  };
}
