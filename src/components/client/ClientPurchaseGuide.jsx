          ...
          <div className="client-guide__grid">
            <section className="client-guide__block">
              ...
              <ul className="client-guide__list">
                ...
                <li>
                  <strong>Списком</strong> — полный список по крупным блокам: стеллажи и каркас, сантехника, электрика,
                  климат… Одинаковые позиции с разных стеллажей уже объединены.
                </li>
                <li>
                ...
                <li>
                  <strong>Заказано/Куплено</strong> — всё, что уже заказано или получено.
                </li>
              </ul>
            </section>
            <section className="client-guide__block">
              ...
              <ul className="client-guide__list">
                ...
                <li>
                  После оплаты нажмите <strong>«Заказано/Куплено»</strong> — позиция уйдёт из основного списка. Когда
                  товар получен — нажмите ещё раз (станет «Куплено»). Смотреть всё — режим «Заказано/Куплено».
                </li>
                <li>Если товар уже на объекте — <strong>«Уже есть»</strong>.</li>
