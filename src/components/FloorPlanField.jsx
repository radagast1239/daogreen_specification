      ...
      <div className="between wrap" style={{ gap: 12, marginBottom: src ? 12 : 0 }}>
        <div>
          ...
          <p className="muted" style={{ fontSize: 12, margin: "4px 0 0", maxWidth: 640 }}>
            План с трубами, стеллажами и зонами — общая схема объекта (`floorPlanUrl`). «Заменить» и «Убрать»
            меняют только её. Дополнительные схемы (трубы, электрика…) — в блоке «Схемы для клиента». Нажмите на
            превью или «Открыть схему» — просмотр поверх страницы, без новой вкладки.
          </p>
        </div>
