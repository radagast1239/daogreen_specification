...
export const LAYER_TOOLS = {
  ...
  climate:     ["select", "link", "measure", "label", "pan"],
  vent:        ["select", "line", "link", "measure", "label", "pan"],
  staff:       ["select", "line", "measure", "label", "pan"],
  sanitary:    ["select", "link", "measure", "label", "pan"],
...
export const CATALOG = [
  ...
  { kind: "door_slide",    label: "Дверь откатная",     w: 1000, h: 120, color: "#14201b", icon: "door_slide",    layer: "room", wall: true },
  { kind: "door_pivot",    label: "Дверь маятниковая",  w: 900,  h: 120, color: "#14201b", icon: "door_pivot",    layer: "room", wall: true },
  { kind: "door_cold",     label: "Дверь холодильная",  w: 900,  h: 120, color: "#14201b", icon: "door_cold",     layer: "room", wall: true },
  { kind: "door_sanitary", label: "Дверь санитарная",   w: 900,  h: 120, color: "#14201b", icon: "door_sanitary", layer: "room", wall: true },
  { kind: "door_wash",     label: "Дверь грязная зона", w: 900,  h: 120, color: "#14201b", icon: "door_wash",     layer: "room", wall: true },
  { kind: "door_tech",     label: "Дверь техническая",  w: 900,  h: 120, color: "#14201b", icon: "door_tech",     layer: "room", wall: true },
  { kind: "door_gate",     label: "Ворота",             w: 1800, h: 140, color: "#14201b", icon: "door_gate",     layer: "room", wall: true },
  { kind: "window",         label: "Окно",                    w: 1200, h: 120, color: "#5b7c9d", icon: "window",         layer: "room", wall: true },
  { kind: "opening",        label: "Технический проём",       w: 900,  h: 120, color: "#6b7d74", icon: "opening",        layer: "room", wall: true },
  { kind: "opening_vent",   label: "Вентиляционный проём",    w: 600,  h: 120, color: "#7a8a9c", icon: "opening_vent",   layer: "room", wall: true },
  { kind: "opening_tech",   label: "Технологическое окно",    w: 1000, h: 120, color: "#1f6f8b", icon: "opening_tech",   layer: "room", wall: true },
  { kind: "opening_serve",  label: "Окно выдачи продукции",   w: 800,  h: 120, color: "#116355", icon: "opening_serve",  layer: "room", wall: true },
  { kind: "opening_arch",   label: "Арочный проём",           w: 1000, h: 120, color: "#5b7c9d", icon: "opening_arch",   layer: "room", wall: true },
  // ── Персонал ──
...
/** Правила инженерных связей — см. linkRules.js */
