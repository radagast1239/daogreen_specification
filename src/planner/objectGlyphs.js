...
const GLYPH_ICONS = new Set([
  ...
  "tank_rect", "tank_round", "tank", "tank_waste",
  "pump_inline", "pump_station", "pump",
...
const KIND_ICON_FALLBACK = {
  ...
  light_panel: "light",
  air_conditioner: "ac_indoor",
  ac_indoor: "ac_indoor",
  ac_outdoor: "ac_out",
  dehumidifier: "ac_indoor",
  humidifier: "ac_indoor",
  climate_controller: "panel",
  temperature_sensor: "socket",
  humidity_sensor: "socket",
  co2_sensor: "socket",
  air_quality_sensor: "socket",
  dew_point_sensor: "socket",
  pressure_sensor: "socket",
  supply: "vent",
  exhaust: "vent",
  duct_damper: "vent",
  airflow_arrow: "vent",
  lighting_group: "panel",
  cable_tray: "panel",
  junction_box: "panel",
  switch: "socket",
  sensor: "socket",
