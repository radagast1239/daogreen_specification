...
export const DG_THEME = {
  ...
  sanitary: "#1f6f8b",
  furniture: "#6b7d74",
  zoneNeutral: "rgba(17, 99, 85, 0.08)",
  zoneClean: "rgba(31, 111, 139, 0.05)",
  zoneDirty: "rgba(122, 92, 62, 0.05)",
  zoneWaste: "rgba(165, 55, 31, 0.05)",
  zoneTech: "rgba(107, 125, 116, 0.05)",
  hover: "#2a9d8f",
  select: "#116355",
};
